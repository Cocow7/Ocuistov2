...
$pdo = new PDO('mysql:host=localhost; dbname=ocuisto', 'root', '', array(
...
define('site_root', '/ocuistov2');// ici on indique le dossier dans lequel se trouve le site à partir de "localhost". S'il n'est dans aucun dossier, on met un "/" seul. Permet de créer des chemins absolus à partir de "localhost". 
